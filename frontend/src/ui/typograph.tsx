    ...
    "text-gray-500 text-start",
    {
        variants: {
            variant: {
                ...
                heading: 'text-[40px] md:text-5xl  text-center md:pt-20 bg-clip-text text-transparent bg-linear-to-r to-[#00003E] from-[#0000A4] bg-clip leading-tight font-telegraf',
